...
Every single time you type in the name of a state, then that state gets labelled on the map and you score one point. The goal is to be able to name as many states as you can remember.
